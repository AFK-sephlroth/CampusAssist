...
// FIX: CampusAssistTheme now accepts an explicit `darkTheme` parameter that
// is driven from outside (MainActivity reads it from SessionManager).
// The default of isSystemInDarkTheme() is kept so previews and tests that
// don't pass a value continue to work correctly.
//
// Theme.kt (the auto-generated scaffold file) is intentionally left untouched;
// it is unused in this project because CampusAssistTheme is the real theme.
@Composable
